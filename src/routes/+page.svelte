<ion-card>
	...
	<ion-button hidden={false} target="_new" fill="outline" slot="end">View</ion-button>
	<ion-item>
	...
	<div on:click={console.log} on:keydown={console.log}>sads</div>
	<ion-item>
