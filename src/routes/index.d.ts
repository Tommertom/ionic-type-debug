...
// ISSUE - apparantly putting HTMLAttributes<HTMLBaseElement> directly in IntrinsicElements does not work
// example -       'ion-button': IonButton | HTMLBaseAttributes;
// example - does not work       'ion-button': IonButton | HTMLAttributes<HTMLBaseElement>;
// What does not work - VS Code does not give typescript error when misspelling an attribute
//  so no curles underneath <ion-button hthisiswrongsref="https://ionicsvelte.firebaseapp.com/" 
//  that is why we need an empty interface
